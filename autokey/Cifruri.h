...
char alphabetMatrixAutokey [matrixSizeAutokey][matrixSizeAutokey];
...
char* autokeyEncrypt(char* ,char* ,char, char,  char* );
char* autokeyDecrypt(char* ,char* ,char, char,  char* );
